...
python ppo_mamba.py --gym-id ${ENV_ID} --mamba-version v1 --seed ${SEED} --total-timesteps ${TOTAL_TIMESTEPS} --num-envs ${NUM_ENVS} --num-minibatches ${NUM_MINIBATCHES} --expand 1 --hidden-dim 256 --wandb-project-name ${WANDB_PROJECT} --exp-name ppo_mamba_${ENV_ID} --track
python ppo_mamba.py --gym-id ${ENV_ID} --mamba-version v2 --seed ${SEED} --total-timesteps ${TOTAL_TIMESTEPS} --num-envs ${NUM_ENVS} --num-minibatches ${NUM_MINIBATCHES} --expand 1 --d-state 64 --d-conv 4 --hidden-dim 256 --wandb-project-name ${WANDB_PROJECT} --exp-name ppo_mamba2_${ENV_ID} --track
python ppo_lstm.py --gym-id ${ENV_ID} --seed ${SEED} --total-timesteps ${TOTAL_TIMESTEPS} --num-envs ${NUM_ENVS} --num-minibatches ${NUM_MINIBATCHES} --rnn-type lstm --rnn-hidden-dim 256 --wandb-project-name ${WANDB_PROJECT} --exp-name ppo_lstm_${ENV_ID} --track
python ppo_lstm.py --gym-id ${ENV_ID} --seed ${SEED} --total-timesteps ${TOTAL_TIMESTEPS} --num-envs ${NUM_ENVS} --num-minibatches ${NUM_MINIBATCHES} --rnn-type gru --rnn-hidden-dim 256 --wandb-project-name ${WANDB_PROJECT} --exp-name ppo_gru_${ENV_ID} --track
python ppo.py --gym-id ${ENV_ID} --seed ${SEED} --total-timesteps ${TOTAL_TIMESTEPS} --num-envs ${NUM_ENVS} --num-minibatches ${NUM_MINIBATCHES} --hidden-dim 256 --frame-stack 4 --wandb-project-name ${WANDB_PROJECT} --exp-name ppo_4_${ENV_ID} --track
